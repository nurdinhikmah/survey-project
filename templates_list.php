	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_templates"><i class="fa fa-plus"></i> Add New Templates</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT survey_set.*, users.*
					FROM survey_set
					...
					<tr>
						...
						<td><b class="truncate"><?php echo $row['category'] ?></b></td>
						<td><b class="truncate"><?php echo $row['fullname'] ?></b></td>
						...
						<td class="text-center">
		                    ...
		                    <div class="btn-group">
		                        <a href="./index.php?page=edit_templates&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat">
		                          <i class="fas fa-edit"></i>
		                        </a>
		                        <a  href="./index.php?page=view_templates&id=<?php echo $row['id'] ?>" class="btn btn-info btn-flat">
