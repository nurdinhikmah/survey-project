				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="fullname" class="form-control form-control-sm" required value="<?php echo isset($fullname) ? $fullname : '' ?>">
						</div>
						<div class="form-group">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Respondent</option>
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Researcher</option>
