...
<div class="col-lg-12">
	<div class="card card-outline card-success">
		...
		<a class="btn btn-primary btn-sm btn-primary btn-flat " href="./index.php?page=new_user"><i class="fa fa-plus"></i> Add New User</a>
		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$type = array('',"Admin","Researcher","Respondent");
					$qry = $conn->query("SELECT *,concat(fullname) as name FROM users order by concat(fullname) asc");
